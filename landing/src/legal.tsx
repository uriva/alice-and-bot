  ...
  return (
    ...
    <ul>
      <li>
        ...
        means that only you and your conversation partner(s) can read the
        content of your messages. The service operators and developers do{" "}
        <em>not</em> have access to your message contents.
      </li>
      <li>
        <strong>Data:</strong>{" "}
        While message contents are encrypted, certain metadata (such as
        timestamps or user identifiers) may be stored to enable the functioning
        of the service.
      </li>
      <li>
        <strong>Usage:</strong>{" "}
