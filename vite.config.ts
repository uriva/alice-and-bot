...
export default defineConfig({
  ...
  resolve: {
    alias: { "decode-named-character-reference": decodePath, "@uri/gamla": resolve(__dirname, "node_modules/@jsr/uri__gamla/src/index.ts"), "typed-api": resolve(__dirname, "node_modules/@jsr/uri__typed-api/src/main.ts") },
  },
});
