...
export class ChatBox extends LitElement {
  ...
  declare onEdit:
    ...
    | undefined;
  declare onReact:
    | ((messageId: string, emoji: string, remove?: boolean) => void)
    | undefined;
    ...
    return html`
      ...
      >
            ...
            <div data-testid="title-bar" style="${titleStyle(
              ...
              <div
                style="${contentMaxWidthStyle(customColors)
                  ...
                  : ""}width:100%;display:flex;align-items:center;padding:0 ${this.onClose ? "16px" : "44px"} 0 16px"
              >
        ...
        >
          <div
            data-content-inner
            style="display:flex;flex-direction:column;gap:8px;padding:12px 12px ${this
              ._inputAreaHeight}px 12px;flex-grow:1;box-sizing:border-box;min-width:0;${contentMaxWidthStyle(
                customColors,
              )}"
          >
            ${this.isLoading
